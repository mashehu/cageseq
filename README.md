...
```bash
nextflow run nf-core/cageseq -profile test,<docker/singularity/conda>
```
...
```bash
nextflow run nf-core/cageseq -profile <docker/singularity/conda> --reads '*_R{1,2}.fastq.gz' --genome GRCh37
```
...
For further information or help, don't hesitate to get in touch on [Slack](https://nfcore.slack.com/channels/nf-core/cageseq) (you can join with [this invite](https://nf-co.re/join/slack)).
